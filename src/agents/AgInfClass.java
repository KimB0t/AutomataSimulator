 ...
 * @author Karim
 */
public class AgInfClass extends Agent{
    ...
    public AgInfClass(int i, int j, int id, int cls) {
        super(i, j, id);
        this.classe = cls;
    }
...
//    @Override
    public AgInfClass move(Params param, Neighbours nghbrs, Cell new_cell) {
        ...
        else if(((CellInfClass)new_cell).isMinStateAtK(param.MLEVEL, this.classe)) {
        ...
        if(delta != null) {
            ...
            ag = new AgInfClass(delta.getI(), delta.getJ(), 
                    this.getId(), this.classe);
        }
        return ag;
    }
